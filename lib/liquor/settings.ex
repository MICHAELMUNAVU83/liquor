defmodule Liquor.Settings do
  ...
  defp defaults do
    %{
      ...
      "about_hero_desc" => fn ->
        "We bring the world's finest spirits, wines, and craft beers straight to your door. Whether you're stocking a home bar or searching for the perfect gift, our curated selection and knowledgeable team are here to help."
      end,
      "about_hero_image" => fn ->
        "https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=900&auto=format&fit=crop"
      end,
      "about_mission" => fn ->
        "Our mission is to connect people with exceptional drinks from around the world. We believe great occasions deserve great bottles, and we're committed to making premium spirits, wines, and beers accessible to everyone.\n\nFrom everyday favourites to rare collector's expressions, we hand-pick every product in our range for quality, provenance, and value — so you can shop with confidence."
      end,
      "about_values" => fn ->
        "Quality first. Every product is verified for authenticity before it reaches our shelves. We work directly with distilleries, wineries, and trusted importers to guarantee provenance.\n\nCustomer obsession. Fast delivery, easy returns, and a team of experts ready to answer your questions — we measure success by how happy you are with every order."
      end,
      ...
      "receipt_delivery_message" => fn -> "For 24/7 doorstep delivery call 0724261261" end
    }
  end
